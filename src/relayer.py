...
def main():
    ...
    pt_chain_one = connect.BlockchainConnect(args.chain_one_port, args.chain_one_name)
    ...
    pt_chain_two = connect.BlockchainConnect(args.chain_two_port, args.chain_two_name)
